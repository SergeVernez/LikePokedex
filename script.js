document.addEventListener("DOMContentLoaded", () => {
	...
	document.body.appendChild(paginationContainer); // ajoute la pagination en fin de page

	const POKEMON_PER_PAGE = 15; // Nombre de Pokémon par page à 15
	let currentPage = 1; // Définit la page actuelle. Donc affiche 15 Pokémon/page
	...
	document.getElementById("backToTop").addEventListener("click", function () {
		...
		document.documentElement.scrollTop = 0; // Pour Chrome, etc...
	});
});
